...
func init() {
	...
	fakeAuthTokens["7b89ab36-524b-11e8-bc8b-3b395b206d1f"] = &authItem{Domains: []string{"domain.a", "domain.b", "test.pvt"}}
	fakeAuthTokens["7c20cd0e-524b-11e8-bcf5-2fb7fb8b1b6a"] = &authItem{Domains: []string{"domain.c", "domain.d", "test2.pvt"}}
}
